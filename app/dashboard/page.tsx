...
export default function DashboardPage() {
  ...
  const apiCount = DEFAULT_ENDPOINTS.filter(e => e.type === 'api').length;
  const dbCount = DEFAULT_ENDPOINTS.filter(e => e.type === 'database').length;
        ...
        <header className="mb-8">
          ...
          <div className="mt-4 flex items-center gap-4">
            <div className="text-sm text-slate-600">
              Monitoring <span className="font-semibold">{DEFAULT_ENDPOINTS.length}</span> endpoints
